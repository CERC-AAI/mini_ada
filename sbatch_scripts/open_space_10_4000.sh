#!/bin/bash
#SBATCH --job-name=open_space_10x10_4000
...
python template_generator.py map.height=10 map.coverage_ratio=1 map.rewrite=False map.start_index=4000 map.end_index=8000