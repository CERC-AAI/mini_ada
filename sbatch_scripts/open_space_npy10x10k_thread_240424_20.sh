...
python -u main_thread.py map.height=20 map.coverage_ratio=0.9 map.rewrite=False map.start_index=100 map.end_index=10000 map.output_folder=$SCRATCH/Public/miniada/maps thread.thread_count=20 thread.batch_size=100000 map.timeout_duplicates=50